...
class CategoriesController extends Controller
{
    ...
    {
        $categories = $this->repository->where('has_child', '=', 1)->orWhere('parent_id', '!=', 0)->get();
    ...
    {
        $categories = $this->repository->with(['allLevelChildren'])->where('parent_id', '=', 0)->where('has_child', '=', 1)->get();
    ...
    public function show($slug)
    {
        ...
        $categories = $this->repository->with(['allLevelChildren'])->where('parent_id', '!=', 0)->where('has_child', '=', 0)->get();
