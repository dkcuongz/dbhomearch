...
@section('content')
    <form action="{{route('admin.banners.update', $banner)}}" method="post" enctype="multipart/form-data" id="upload-image">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" name="status"  {{ $banner->status == '1' ? 'checked' : '' }} id="status" value="1">
