...
@section('title', 'Tạo mới dự án')

@section('content_header')
    <h1 class="m-0 text-dark">Tạo mới dự án</h1>
@stop

@section('content')
    <form action="{{route('admin.projects.store')}}" method="post" enctype="multipart/form-data" id="upload-image">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
...
{{--                                <input class="form-check-input" type="checkbox" name="is_reality" id="is_reality" value="1">--}}
{{--                                <label class="form-check-label" for="flexRadioDefault1">--}}
{{--                                    Công trình thực tế--}}
{{--                                </label>--}}
{{--                            </div>--}}
