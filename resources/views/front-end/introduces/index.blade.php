        ...
        <div class="about-page row pt-xl-5">
            <div class="content col-12 col-md-6">
                <div class="contain wow animate__fadeInUp" data-wow-duration=".5s"
                    ...
                    <!-- wp:paragraph -->
                    <p>Với TD architects, chúng tôi không chỉ xem mình là những người kể chuyện và mang những tình tiết
                        trong “câu chuyện” ấy hiện hữu trong từng công trình, yếu tố quan trọng nhất với TD archiects
                        vẫn sẽ luôn là “con người”. Bởi sau cùng, tất cả những cảm hứng, những sáng tạo, một khi chúng
                        xoay quanh “con người” thì tất cả đều là sẽ những ý tưởng tinh tế nhất, nhân văn nhất. Một bản
                        thiết kế chỉ thật sự có giá trị khi chúng sinh ra vì con người, khi chúng cân bằng được giữa
                        khao khát và hiện thực để từ đó tạo nên một công trình không chỉ còn là “trong mơ” cho từng gia
                        chủ: đó có thể là nhà, là nơi chốn đi về, hoặc cũng có thể là một nhà hàng, một quán cà phê,…
                        nơi gia gia đủ đặt viên gạch đầu tiên trong sự nghiệp của mình. </p>
                    <!-- /wp:paragraph -->

                    <!-- wp:paragraph -->
                    <p>Chính vì vậy, ngay từ khi mới bắt đầu những bước đầu tiên vào năm 2015, TD architects đã luôn duy
                        trì định hướng ấy cho đến tận hôm nay khi đã đồng hành cùng khách hàng qua hàng trăm công trình
                        lớn nhỏ.</p>
                    <!-- /wp:paragraph -->            </div>
            </div>
            ...
            <div class="content ltr col-12 col-md-6">
                <div class="contain wow animate__fadeInUp" data-wow-duration=".5s" data-wow-delay=".3s"
                    ...
                    <p></p>
                    <p>Với đội ngũ giàu kinh nghiệm cùng với các bạn trẻ ham học hỏi và sáng tạo những cái mới, TD
                        architects đi tiên phong trong việc nghiên cứu ứng dụng công nghệ và vật liệu mới trong công
                        cuộc hành nghề của mình. Chúng tôi tin tưởng rằng, với thế mạnh nổi trội của TD architects thể
                        hiện ở đội ngũ thiết kế sáng tạo và quy trình quản lý chặt chẽ sẽ cung cấp dịch vụ tốt nhất, đáp
                        ứng mọi nhu cầu và mang lại sự hài lòng đến với mọi khách hàng.</p>
                    <p>Từ đó, TD architects không chỉ là một người bạn đồng hành thuần tuý mà chúng tôi luôn đặt mục
        ...
        <div class="team-profile">
            <div class="content col-12 col-md-6">
                <div class="contain wow animate__fadeInUp" data-wow-duration=".5s"
                    ...
                    Con người đóng vai trò quan trọng để làm nên thành công trong suốt gần một thập kỷ qua của TD
                    architects. Đội ngũ nhân viên tại TD architects với chuyên môn giỏi về thiết kế và thi công công
                    trình đã được công nhận năng lực đồng thời được xem là một công ty phát triển nhanh và uy tín.
                </div>
            </div>
            <div class="folio-slide pt-xl-5 col-12 col-md-12">
                    ...
                    <div class="swiper-wrapper" id="swiper-wrapper-5549eaf3da6bcd64" aria-live="polite"
                        ...
                        <div class="swiper-slide wow animate__fadeInUp swiper-slide-active" data-wow-duration=".5s"
                            ...
                            <div class="caption">
                                ...
                                <div class="name">NGUYỄN NHƯ Ý</div>
                                <div class="level">Interior Designer</div>
                                <div class="email">
                                    <a href="mailto:ynguyen.tdarch@gmail.com">ynguyen.tdarch@gmail.com</a>
                                </div>
                                <div class="phone">
                                    <a href="tel:0985530554">+ 098 553 0 554</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-button-next-custom swiper-button swiper-button-disabled swiper-button-lock"
                     tabindex="-1" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-5549eaf3da6bcd64"
